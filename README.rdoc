...
There're some new features I have made on the original gem:

* Rack::JSONP - Translate the status code 40x and 50x into a json string and set it in response,
  so the client could get a message even when the server end throws 40x and 50x.
